...
import com.syt.jabx.kernel.JABXTradeBillsTool;
import com.syt.jabx.kernel.JABXTradeReportTool;
...
/**
 * 應用程序組成類別<br>
 * N99為綜合版，含行情報價，用戶相關訊息，交易帳務系統及交易回報系統。
 * @author jason
 *
 */
public class JABXCore {
	 ...
	 * 核心版本號
	 */
	private final static String VERSION = "N99_V2.0";
	 ...
	 */
	public final static int OBJ_SERVER_INFO = OBJ_KERNEL_REQUEST + 2;

	/**
	 * 取得IJABXUserAvailableProductClass物件所使用之常數
	 */
	public final static int OBJ_USER_INFO = OBJ_KERNEL_REQUEST + 3;

	/**
	 * 取得IJABXExchangeInfoOverview物件所使用之常數
	 */
	public final static int OBJ_EXCHANGE_INFO = OBJ_KERNEL_REQUEST + 4;
	 ...
	 * 取得交易及帳務工具物件所使用之常數
	 */
	public final static int OBJ_TRADEBILLS_REQUEST = OBJ_KERNEL_REQUEST + 103;

	/**
	 * 取得委託及成交即時回報工具物件所使用之常數
	 */
	public final static int OBJ_TRADEREPORT_REQUEST = OBJ_KERNEL_REQUEST + 104;
	 ...
	 * 交易及帳務工具物件
	 */
	private JABXTradeBillsTool tradeBillsTool;

	/**
	 * 委託及成交即時回報工具物件
	 */
	private JABXTradeReportTool tradeReportTool;
	...
	public JABXCore(IJABXOutputMsg outputMsg, IJABXNotifier notifier, boolean isReservedData, char apiEdition) {
		...
		tradeBillsTool = new JABXTradeBillsTool(jabxKernel, jabxKernel.getJLog());
		tradeReportTool = new JABXTradeReportTool(jabxKernel, jabxKernel.getJLog());
	...
	/**
	 * 查詢API應用之介面
	 * @param queryIndex - int(介面常數)<br>
	 * 常數對應之物件如下所示:<br>
	 * &nbsp;&nbsp;&nbsp;&nbsp;JABXCore.OBJ_SERVER_INFO: JSONArray<br>
	 * &nbsp;&nbsp;&nbsp;&nbsp;JABXCore.OBJ_USER_INFO: JSONObject<br>
	 * &nbsp;&nbsp;&nbsp;&nbsp;JABXCore.OBJ_EXCHANGE_INFO: JSONObject<br>
	 * &nbsp;&nbsp;&nbsp;&nbsp;JABXCore.OBJ_USER_REQUEST: IJABXUserRequest<br>
	 * &nbsp;&nbsp;&nbsp;&nbsp;JABXCore.OBJ_QUOTE_REQUEST: IJABXQuoteRequest<br>
	 * &nbsp;&nbsp;&nbsp;&nbsp;JABXCore.OBJ_TRADEBILLS_REQUEST: IJABXTradeBillsRequest(交易帳務版可用)<br>
	 * &nbsp;&nbsp;&nbsp;&nbsp;JABXCore.OBJ_TRADEREPORT_REQUEST: IJABXTradeReportRequest(交易回報版可用)
	 * @return Object
	 */
	public Object queryInterface(int queryIndex) {
		...
		case OBJ_QUOTE_REQUEST:
			...
			break;
		case OBJ_TRADEBILLS_REQUEST:
			obj = tradeBillsTool.getRequest();
			break;
		case OBJ_TRADEREPORT_REQUEST:
			obj = tradeReportTool.getRequest();
			break;
		}
		return obj;
	}
