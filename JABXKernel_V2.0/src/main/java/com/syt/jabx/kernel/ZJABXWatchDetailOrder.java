...
import com.syt.jabx.watch.IJABXDetailOrder;
 ...
 *
 */
final class ZJABXWatchDetailOrder implements IJABXDetailOrder {
	 ...
	 */
	public ZJABXWatchDetailOrder copyData() {
		ZJABXWatchDetailOrder detailOrder = new ZJABXWatchDetailOrder();
