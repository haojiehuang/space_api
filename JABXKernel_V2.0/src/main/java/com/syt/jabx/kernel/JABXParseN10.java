 ...
 *
 */
public final class JABXParseN10 extends IJABXParseBase implements IJABXParseBody {
	 ...
	 */
	public JABXParseN10(JABXKernel jabxKernel, IJABXLog jabxLog, IJABXParseFactory parseFactory) {
	...
	public void parse(final ZJABXFixProc fixProc, final JSONObject result,
		...
		try {
			...
			result.put(JS_Result.FUNC_ID, JABXConst.ABXFUN_REBUILD_NEWS);
			...
			result.put(JS_Result.NOTIFIED, true);
			jabxLog.outputErrorAndLog("JABXParseN10.parse()", e.getMessage());
			e.printStackTrace();
		}catch(IOException e) {
