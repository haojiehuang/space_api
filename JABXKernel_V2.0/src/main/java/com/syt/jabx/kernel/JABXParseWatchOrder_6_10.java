 ...
 *
 */
public final class JABXParseWatchOrder_6_10 extends IJABXParseBase implements IJABXParseBody {
	 ...
	 * @param srcObj - Object
	 */
	public JABXParseWatchOrder_6_10(JABXKernel jabxKernel, IJABXLog jabxLog, JABXQuoteTool quoteTool, Object srcObj) {
	...
	public void parse(final ZJABXFixProc fixProc, final JSONObject result,
		...
		try{
			...
			ZJABXWatchOrder_6_10 order_6_10 = item.getOrder_6_10();
			if (order_6_10 == null) {
				order_6_10 = new ZJABXWatchOrder_6_10();
				item.setOrder_6_10(order_6_10);
			}
			StringBuffer parameterSb = new StringBuffer("00000000000000000000");

			ZJABXBestOrder bestOrder = order_6_10.getBestOrder();
			...
			while (nRead < dataAry.length) {
				...
				case 8:// 第9買量
					...
					break;
				case 9:// 第10買價
					orderItem = (ZJABXBestOrderItem)bestOrder.atIndex(4);
					orderItem.setBidPrice(fixProc.getIntValue(tagValue.getValue()));
				...
				case 17:// 第9賣價
					orderItem = (ZJABXBestOrderItem)bestOrder.atIndex(3);
					orderItem.setAskPrice(fixProc.getIntValue(tagValue.getValue()));
					parameterSb.replace(16, 17, "1");
					break;
				case 18:// 第9賣量
					orderItem = (ZJABXBestOrderItem)bestOrder.atIndex(3);
					orderItem.setAskVolume(fixProc.getIntValue(tagValue.getValue()));
					parameterSb.replace(17, 18, "1");
					break;
				case 19:// 第10賣價
					orderItem = (ZJABXBestOrderItem)bestOrder.atIndex(4);
					orderItem.setAskPrice(fixProc.getIntValue(tagValue.getValue()));
					parameterSb.replace(18, 19, "1");
					break;
				case 20:// 第10賣量
					orderItem = (ZJABXBestOrderItem)bestOrder.atIndex(4);
					orderItem.setAskVolume(fixProc.getIntValue(tagValue.getValue()));
					parameterSb.replace(19, 20, "1");
					break;
				}
			}
			if (offset == 0) {
				result.put(JS_Result.FUNC_ID, JABXConst.ABXFUN_REALTIME);
				result.put(JS_Result.STATUS_ID, JABXConst.ABXMSG_ORDER_6_10);
			...
			jabxLog.outputErrorAndLog("JABXParseWatchOrder_6_10.parse()", e.getMessage());
			e.printStackTrace();
		}
	}
}