 ...
 *
 */
public final class JABXParseS10 extends IJABXParseBase implements IJABXParseBody {
	 ...
	 */
	public JABXParseS10(IJABXLog jabxLog) {
		...
		try{
			...
			while (nRead < dataAry.length) {
				...
				case 2:// 錯誤訊息
					...
					break;
				case 3:// 接收訊息序號
					seqNo = fixProc.getValue(tagValue.getValue(), "");
					break;
				}
			}
			...
			result.put(JS_Result.NOTIFIED, true);
			jabxLog.outputErrorAndLog("JABXParseS10.parse()", e.getMessage());
			e.printStackTrace();
		}
	}
}