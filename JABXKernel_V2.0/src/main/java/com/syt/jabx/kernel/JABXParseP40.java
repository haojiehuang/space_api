 ...
 *
 */
public final class JABXParseP40 extends IJABXParseBase implements IJABXParseBody {
	 ...
	 */
	public JABXParseP40(IJABXLog jabxLog) {
	...
	public void parse(final ZJABXFixProc fixProc, final JSONObject result,
		...
		try{
			...
			result.put(JS_Result.FUNC_ID, JABXConst.ABXFUN_QUERY_SORTQUOTEDATA);
			...
			result.put(JS_Result.NOTIFIED, true);
			jabxLog.outputErrorAndLog("JABXParseP40.parse()", e.getMessage());
			e.printStackTrace();
		}
	}
}