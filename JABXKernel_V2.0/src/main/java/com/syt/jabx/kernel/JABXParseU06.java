 ...
 *
 */
public final class JABXParseU06 extends IJABXParseBase implements IJABXParseBody {
	 ...
	 */
	public JABXParseU06(JABXKernel jabxKernel, IJABXLog jabxLog) {
	...
	public void parse(final ZJABXFixProc fixProc, final JSONObject result,
		...
		try{
			...
			result.put(JS_Result.NOTIFIED, true);
			jabxLog.outputErrorAndLog("JABXParseU06.parse()", e.getMessage());
			e.printStackTrace();
		}
	}
}