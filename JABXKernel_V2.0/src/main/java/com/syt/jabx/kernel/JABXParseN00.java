 ...
 *
 */
public final class JABXParseN00 extends IJABXParseBase implements IJABXParseBody {
	 ...
	 */
	public JABXParseN00(JABXKernel jabxKernel, IJABXLog jabxLog, IJABXParseFactory parseFactory) {
	...
	public void parse(final ZJABXFixProc fixProc, final JSONObject result,
		...
		try{
			...
			result.put(JS_Result.FUNC_ID, JABXConst.ABXFUN_REBUILD_EXCHANGEBULLETIN);
			...
			result.put(JS_Result.NOTIFIED, true);
			jabxLog.outputErrorAndLog("JABXParseN00.parse()", e.getMessage());
			e.printStackTrace();
		}catch(IOException e) {
