 ...
 *
 */
public final class JABXParseU02 extends IJABXParseBase implements IJABXParseBody {
	 ...
	 */
	public JABXParseU02(JABXKernel jabxKernel, IJABXLog jabxLog) {
	...
	public void parse(final ZJABXFixProc fixProc, final JSONObject result,
		...
		try{
			...
			result.put(JS_Result.NOTIFIED, true);
			jabxLog.outputErrorAndLog("JABXParseU02.parse()", e.getMessage());
			e.printStackTrace();
		}
	}
}