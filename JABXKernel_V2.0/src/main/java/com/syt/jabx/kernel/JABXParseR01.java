 ...
 *
 */
public final class JABXParseR01 extends IJABXParseBase implements IJABXParseBody {
	 ...
	 */
	public JABXParseR01(JABXKernel jabxKernel, IJABXLog jabxLog, JABXQuoteTool quoteTool, IJABXParseFactory parseFactory) {
	...
	public void parse(final ZJABXFixProc fixProc, final JSONObject result,
		...
		ZJABXQuoteOverview quoteOverview = new ZJABXQuoteOverview(quoteTool);
		try{
			...
			result.put(JS_Result.FUNC_ID, JABXConst.ABXFUN_REBUILD_QUOTE);
			...
			result.put(JS_Result.NOTIFIED, true);
			jabxLog.outputErrorAndLog("JABXParseR01.parse()", e.getMessage());
			e.printStackTrace();
		}catch(IOException e) {
