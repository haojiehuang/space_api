 ...
 *
 */
public final class JABXParseU07 extends IJABXParseBase implements IJABXParseBody {
	 ...
	 */
	public JABXParseU07(JABXKernel jabxKernel, IJABXLog jabxLog) {
	...
	public void parse(final ZJABXFixProc fixProc, final JSONObject result,
		...
		try{
			...
			result.put(JS_Result.NOTIFIED, true);
			jabxLog.outputErrorAndLog("JABXParseU07.parse()", e.getMessage());
			e.printStackTrace();
		}
	}
}