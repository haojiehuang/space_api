 ...
 *
 */
public final class JABXParseU04 extends IJABXParseBase implements IJABXParseBody {
	 ...
	 */
	public JABXParseU04(JABXKernel jabxKernel, IJABXLog jabxLog) {
	...
	public void parse(final ZJABXFixProc fixProc, final JSONObject result,
		...
		try{
			...
			result.put(JS_Result.NOTIFIED, true);
			jabxLog.outputErrorAndLog("JABXParseU04.parse()", e.getMessage());
			e.printStackTrace();
		}
	}
}