 ...
 *
 */
public final class JABXParseP59 extends IJABXParseBase implements IJABXParseBody {
	 ...
	 */
	public JABXParseP59(JABXKernel jabxKernel, IJABXLog jabxLog) {
	...
	public void parse(final ZJABXFixProc fixProc, final JSONObject result,
		...
		try {
			...
			result.put(JS_Result.NOTIFIED, true);
			jabxLog.outputErrorAndLog("JABXParseP59.parse()", e.getMessage());
			e.printStackTrace();
		}
	}
}