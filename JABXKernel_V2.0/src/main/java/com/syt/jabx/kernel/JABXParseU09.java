 ...
 *
 */
public final class JABXParseU09 extends IJABXParseBase implements IJABXParseBody {
	 ...
	 */
	public JABXParseU09(JABXKernel jabxKernel, IJABXLog jabxLog) {
	...
	public void parse(final ZJABXFixProc fixProc, final JSONObject result,
		...
		try{
			...
			result.put(JS_Result.NOTIFIED, true);
			jabxLog.outputErrorAndLog("JABXParseU09.parse()", e.getMessage());
			e.printStackTrace();
		}
	}
}