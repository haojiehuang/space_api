 ...
 *
 */
public final class JABXParseP53 extends IJABXParseBase implements IJABXParseBody {
	 ...
	 */
	public JABXParseP53(JABXKernel jabxKernel, IJABXLog jabxLog) {
	...
	public void parse(final ZJABXFixProc fixProc, final JSONObject result,
		...
		try{
			...
			result.put(JS_Result.FUNC_ID, JABXConst.ABXFUN_REQUERY_TECHNICALINDEXDATA);
			...
			result.put(JS_Result.NOTIFIED, true);
			jabxLog.outputErrorAndLog("JABXParseP53.parse()", e.getMessage());
			e.printStackTrace();
		}
	}
}