...
import com.syt.jabx.watch.IJABXStatistic;
 ...
 *
 */
final class ZJABXWatchStatistic implements IJABXStatistic {
	...
	/**
	 * @see com.syt.jabx.watch.IJABXStatistic#getTradeTime()
	 */
	@Override
	 ...
	 */
	public ZJABXWatchStatistic copyData() {
		ZJABXWatchStatistic item = new ZJABXWatchStatistic();		
