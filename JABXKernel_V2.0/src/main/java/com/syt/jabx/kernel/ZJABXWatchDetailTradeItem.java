...
import com.syt.jabx.watch.IJABXDetailTradeItem;

/**
 * 逐筆成交訊息(目前只support SSE,SZSE)之類別
 * @author Jason
 *
 */
final class ZJABXWatchDetailTradeItem implements IJABXDetailTradeItem {
	 ...
	 */
	public ZJABXWatchDetailTradeItem copyData() {
		ZJABXWatchDetailTradeItem detailTrade = new ZJABXWatchDetailTradeItem();
